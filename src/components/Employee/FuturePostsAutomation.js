...
useEffect(() => {
 ...
 const handleToggleStatus = async () => {
  ...
  useEffect(() => {
    if (isMobile && !localStorage.getItem('futureposts_gesture_guide_seen')) {
  ...
  useEffect(() => {
    if (!isMobile && !localStorage.getItem('futureposts_desktop_gesture_guide_seen')) {
...
const handleLaunchAutomation = async () => {
  ...
  if (flowNodes && flowNodes.length > 0) {
    ...
    // Explanatory Banner for Future Posts Template
          ...
          >
            <CardContent sx={{ p: 0 }}>
              ...
              <Box
                sx={{
                  background: {
                    xs: 'linear-gradient(135deg, #F59E0B 0%, #EF4444 50%, #DC2626 100%)',
                    sm: 'linear-gradient(135deg, #F97316 0%, #EF4444 100%)'
                  },
                  p: { xs: 3, sm: 3.5, md: 4 },
                  pb: { xs: 3.5, sm: 4, md: 5 },
                  position: 'relative',
              ...
              >
                ...
                <Box sx={{ textAlign: 'center', color: 'white', position: 'relative', zIndex: 1 }}>
                  ...
                  >
                    <RocketLaunchIcon sx={{ fontSize: { xs: 36, sm: 42, md: 48 } }} />
                  </Box>
                  <Typography
                    sx={{
                      fontWeight: 700,
                  ...
                  >
                    Set up once, automate forever. One template for all your future posts!
                  </Typography>
                </Box>
              </Box>
              ...
              <Box sx={{ p: { xs: 2.5, sm: 3.5, md: 4 } }}>
                ...
                >
                  <Stack
                    ...
                    sx={{ pl: { xs: 2, sm: 2.5 } }}
                  >
                    <CancelIcon sx={{ color: '#EF4444', fontSize: { xs: 24, sm: 28 }, mt: 0.25 }} />
                    <Box>
                      <Typography
                        sx={{
                          fontWeight: 600,
                      ...
                      >
                        Setting up comment automation for <strong>every single post</strong> is tedious and time-consuming.
                        You have to manually configure DM messages, buttons, flows, and keywords each time you post.
                        This wastes your time and makes scaling your content difficult.
                      </Typography>
                    </Box>
                  </Stack>
                </Box>
                ...
                >
                  <Stack
                    ...
                    sx={{ pl: { xs: 2, sm: 2.5 } }}
                  >
                    <CheckCircleIcon sx={{ color: '#10B981', fontSize: { xs: 24, sm: 28 }, mt: 0.25 }} />
                    <Box>
                      <Typography
                        sx={{
                          fontWeight: 600,
                      ...
                      >
                        The Solution: One Template, Infinite Posts
                      </Typography>
                      <Typography
                        sx={{
                          color: '#065F46',
                      ...
                      >
                        Create a <strong>single automation template</strong> that automatically applies to <strong>all your future Instagram posts</strong>.
                        Set it up once, and every new post you create will have the same comment automation running.
                        Save hours of work and scale your content effortlessly!
                      </Typography>
                    </Box>
                  </Stack>
                </Box>
                    ...
                    {[
                      {
                        ...
                        description: 'Set up your DM message, buttons, and automation flow once',
                        color: '#3B82F6',
                        icon: '✏️'
                      },
                      {
                        ...
                        description: 'Choose keywords that will trigger your automation on comments',
                        color: '#8B5CF6',
                        icon: '🔑'
                      },
                      {
                        step: 3,
                        title: 'Set Auto-Replies',
                        description: 'Configure automatic comment replies to keep engagement high',
                        color: '#EC4899',
                        icon: '💬'
                      },
                      {
                        ...
                        description: 'Activate your template and it applies to all future posts automatically',
                        color: '#F59E0B',
                        icon: '🚀'
                      },
                      {
                        step: 5,
                        title: 'Post & Relax',
                        description: 'Every new post automatically has your automation - no extra work needed!',
                        color: '#10B981',
                        icon: '✨'
                      }
                    ].map((item, index) => (
                        ...
                        <Stack direction="row" spacing={{ xs: 1.5, sm: 2 }} alignItems="flex-start">
                          ...
                          <Box sx={{ flex: 1, pt: { xs: 0.5, sm: 0.75 } }}>
                            <Stack direction="row" spacing={1} alignItems="center" sx={{ mb: 0.5 }}>
                              <Typography sx={{ fontSize: { xs: 18, sm: 20 }, lineHeight: 1 }}>
                                {item.icon}
                              </Typography>
                              <Typography
                                sx={{
                ...
                <Box sx={{ mb: { xs: 2, sm: 3 } }}>
                  ...
                  >
                    ...
                    >
                      <CheckCircleOutlineIcon sx={{ color: 'white', fontSize: { xs: 22, sm: 26, md: 28 } }} />
                    </Box>
                    <Typography
                      sx={{
                        fontWeight: 600,
                  ...
                  <Grid container spacing={{ xs: 1.5, sm: 2 }} sx={{ pl: { xs: 0, sm: 7 } }}>
                    {[
                      { icon: '⏱️', title: 'Save Time', desc: 'No more repetitive setup for each post', gradient: 'linear-gradient(135deg, #DBEAFE 0%, #EFF6FF 100%)' },
                      { icon: '📈', title: 'Scale Content', desc: 'Post more without worrying about automation', gradient: 'linear-gradient(135deg, #F3E8FF 0%, #FAF5FF 100%)' },
                      { icon: '🎯', title: 'Consistency', desc: 'Same professional automation on every post', gradient: 'linear-gradient(135deg, #FEF3C7 0%, #FEF9C3 100%)' },
                      { icon: '🔄', title: 'Auto-Apply', desc: 'Template automatically applies to new posts', gradient: 'linear-gradient(135deg, #D1FAE5 0%, #ECFDF5 100%)' }
                    ].map((benefit, index) => (
                ...
                <Box sx={{ textAlign: 'center', mt: { xs: 3, sm: 4 }, mb: { xs: 1, sm: 0 } }}>
                  ...
                  >
                    Set up your template in under 5 minutes and save hours every week
                  </Typography>
                </Box>
              </Box>
            </CardContent>
        ...
        >
          ...
          <Button
            ...
            onClick={() => {
              ...
              localStorage.setItem('futureposts_gesture_guide_seen', 'true');
            }}
            sx={{
        ...
        >
          ...
          <Button
            ...
            onClick={() => {
              ...
              localStorage.setItem('futureposts_desktop_gesture_guide_seen', 'true');
            }}
            sx={{
              color: 'rgba(255,255,255,0.7)',
              fontSize: 11,
