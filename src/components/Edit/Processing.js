...
/**
 * Step two, while the matching runs.
 *
    ...
    <div className="hg-scroll" style={{ flex: 1, minHeight: 0, display: "grid", placeItems: "center", padding: 20 }}>
      <div style={{ width: "min(520px, 100%)", background: "var(--card)", border: "1px solid var(--line)", borderRadius: 16, padding: "24px 22px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
          <Spinner size={18} />
          <h2 style={{ margin: 0, fontSize: 19, fontWeight: 750, letterSpacing: "-.02em", color: "var(--ink)" }}>Cutting your video to the script</h2>
        </div>
        <p style={{ margin: "0 0 18px", fontSize: 13.5, lineHeight: 1.6, color: "var(--ink-mute)" }}>
          About a minute for a Short, a few for a long video. You can close this; it keeps going and your edit will be here.
        </p>
