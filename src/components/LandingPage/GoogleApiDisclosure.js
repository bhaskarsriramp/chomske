        ...
        <Container maxWidth="lg">
          ...
          <Box mt={8} textAlign="center">
            <Typography variant="caption" color="#64748b">
              Last Updated: January 15, 2026 | If you have questions about this policy, please contact <a href="mailto:support@myhandle.in" style={{ color: '#94a3b8' }}>support@myhandle.in</a>
            </Typography>
          </Box>
