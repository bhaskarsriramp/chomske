 ...
 *
 * A segmented control, not tabs, sitting in the page header beside the title,
 * where a scope control belongs: it changes the whole screen. (There was a
 * third mode, Discover, the news feed; it was removed with the collector.)
 *
 * ── AND WHY IT IS TWO URLS ───────────────────────────────────────────────────
 * Each mode is a real address (/app/import, /app/idea), so back
