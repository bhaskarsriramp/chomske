 ...
 */
export const HEURISTIC_REFUSAL = new Set(["moving", "scrolling", "arrow", "off-control", "nothing-read", "held", "no-press-seen", "still-arriving", "no-consequence-busy", "position-unknown"]);
